---
title: "Iniciação à Estatística no R"
subtitle: "Professor Fernando Bastos - MAF 105/UFV"
...
`r knitr::include_graphics("Figuras/Console_R.jpg")`
...
`r knitr::include_graphics("Figuras/rstudio-editor.png")`
<p style="text-align: justify;">
...
`r knitr::include_graphics("Figuras/beginWork.gif")`
...
<p style="text-align: justify;">
Os comandos acima são equivalentes e podem ser interpretados como: atribua o valor 1 à variável
`x`. Ao criar a variável `x`, o R irá definir `x` como numérico e armazenar numa estrutura de vetor, pois
o 1 é claramente um número. Vetor é a estrutura mais simples que uma variável pode assumir, e somente pode assumir um mesmo
...
```
<p style="text-align: justify;">
Ao longo deste capítulo, criamos n a memória do nosso computador várias variáveis. Você consegue
...
`r knitr::include_graphics("Figuras/projetos.png")`
<p style="text-align: justify;">
...
`r knitr::include_graphics("Figuras/Programacao1.gif")`
<p style="text-align: justify;">
...
<img src="Figuras/desconfiado1.gif" style = "display: block; margin-left: auto; margin-right: auto;">
<p style="text-align: justify;">
...
`r knitr::include_graphics("Figuras/helpMe.gif")`
...
<img src="Figuras/helpMe2.gif" height="300" width="300"> 
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
--
<img src="Figuras/helpMe3.gif" height="300" width="300">
...
# Resumo de Dados
`r knitr::include_graphics("Figuras/Programacao21.gif")`
